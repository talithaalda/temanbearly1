                        ...
                        @if ($produk->find(3) != null)
                            <a href="/produk/{{ $produk->find(3)->slug }}" class="link">
                                <div class="special-img position-relative overflow-hidden">
                                    <img src="{{ asset('storage/' . $produk->find(3)->image) }}" class="w-100" width="300"
                                        height="300">
                                    <span
                                        class="position-absolute bg-primary text-white d-flex align-items-center justify-content-center circle">sale</span>
                                </div>
                                <div class="text-center">
                                    ...
                                    <span class="fw-bold">Rp
                                        {{ number_format($produk->find(3)->harga, 0, '.', '.') }}</span>
                            </a>
                        @endif
                    </div>
                </div>
                    ...
                    <div class="special-img position-relative overflow-hidden">
                        @if ($produk->find(6) != null)
                            <a href="/produk/{{ $produk->find(6)->slug }}" class="link">
                                <img src="{{ asset('storage/' . $produk->find(6)->image) }}" class="w-100" width="300"
                                    height="300">
                                <span
                                    class="position-absolute bg-primary text-white d-flex align-items-center justify-content-center circle">sale</span>
                    </div>
                    ...
                    <div class="special-img position-relative overflow-hidden">
                        @if ($produk->find(4) != null)
                            <a href="/produk/{{ $produk->find(4)->slug }}" class="link">
                                <img src="{{ asset('storage/' . $produk->find(4)->image) }}" class="w-100" width="300"
                                    height="300">
                                <span
                                    class="position-absolute bg-primary text-white d-flex align-items-center justify-content-center circle">sale</span>
                    </div>
                    ...
                    <div class="special-img position-relative overflow-hidden">
                        @if ($produk->find(7) != null)
                            <a href="/produk/{{ $produk->find(7)->slug }}" class="link">
                                <img src="{{ asset('storage/' . $produk->find(7)->image) }}" class="w-100" width="300"
                                    height="300">
                                <span
                                    class="position-absolute bg-primary text-white d-flex align-items-center justify-content-center circle ">sale</span>
        ...
        <div class="container">
            ...
            <div class="special-list row g-0">
                <div class="col-md-6 col-lg-4 col-xl-3 p-2">
                    <div class="special-img position-relative overflow-hidden">
                        <img src="{{ asset('storage/' . $produk->find(9)->image) }}" class="w-100" width="300"
                            height="300">
                ...
                <a class="link" href="/category/{{ $category[0]->slug }}">
                    <div class="special-img position-relative overflow-hidden">
                        ...
                        <div class="card-img-overlay d-flex align-items-center p-0">
                            <h5 class="card-title text-center flex-fill p-2 fs-0 text-capitalize mt-3 mb-1"
                                style="background-color: rgba(0,0,0,0.2)">{{ $category[0]->namakategori }}</h5>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 p-2">
                <a class="link" href="/category/{{ $category[1]->slug }}">
                    <div class="special-img position-relative overflow-hidden">
                        ...
                        <div class="card-img-overlay d-flex align-items-center p-0">
                            <h5 class="card-title text-center flex-fill p-2 fs-0 text-capitalize mt-3 mb-1"
                                style="background-color: rgba(0,0,0,0.2)">{{ $category[1]->namakategori }}</h5>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 p-2">
                <a class="link" href="/category/{{ $category[2]->slug }}">
                    <div class="special-img position-relative overflow-hidden">
                        ...
                        <div class="card-img-overlay d-flex align-items-center p-0">
                            <h5 class="card-title text-center flex-fill p-2 fs-0 text-capitalize mt-3 mb-1"
                                style="background-color: rgba(0,0,0,0.2)">{{ $category[2]->namakategori }}</h5>
                        </div>
                    </div>
                </a>
            </div>
            ...
            <div class="col-md-6 col-lg-4 col-xl-3 p-2">
                <a class="link" href="/category/{{ $category[3]->slug }}">
                    <div class="special-img position-relative overflow-hidden">
                        ...
                        <div class="card-img-overlay d-flex align-items-center p-0">
                            <h5 class="card-title text-center flex-fill p-2 fs-0 text-capitalize mt-3 mb-1"
                                style="background-color: rgba(0,0,0,0.2)">{{ $category[3]->namakategori }}</h5>
                        </div>
                        <!-- end of Category -->
                </a>
            </div>
